...
public class LogAspect {
     ...
     */
    //定义切入点
    @Pointcut("execution(public String com.mam.controller.MyController.myAnnotation(String))") //用于匹配方法执行
    //@Pointcut("@annotation(com.mam.annotation.MyAnnotation)")//用于匹配带有注解的方法
    public void log(){}
